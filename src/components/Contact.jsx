...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "gourmelen.tom@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Merci ! Je vous contacte dès que possible.");
        ...
        (error) => {
          ...
          alert("Désolé, ça n'a malheureusement pas fonctionné. Essayé de nouveau.");
        }
      );
  };
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Prenez contact avec moi</p>
        ...
        >
          ...
          <button
            type='submit'
            className='bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary hover:bg-tertiary-light'
          >
